...
CEIHeader.styles = unsafeCSS(styles$2);
__decorate$2([
  property({type: Array})
], CEIHeader.prototype, "links", 2);
CEIHeader = __decorate$2([
...
let CEIFooter = class extends LitElement {
  render() {
    return html`
...
CEIFooter.styles = unsafeCSS(styles$1);
CEIFooter = __decorate$1([
  customElement("cei-footer")
], CEIFooter);
